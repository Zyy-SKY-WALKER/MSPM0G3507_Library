...
/* Position PID gains in duty/(mm/s), converted from legacy count gains. */
#define DRIVE_ORIGINAL_STRAIGHT_LEFT_KP              (12.24F)
#define DRIVE_ORIGINAL_STRAIGHT_LEFT_KI              (1.77F)
#define DRIVE_ORIGINAL_STRAIGHT_LEFT_KD              (0.68F)
#define DRIVE_ORIGINAL_STRAIGHT_RIGHT_KP             (12.24F)
#define DRIVE_ORIGINAL_STRAIGHT_RIGHT_KI             (1.77F)
#define DRIVE_ORIGINAL_STRAIGHT_RIGHT_KD             (0.68F)
#define DRIVE_ORIGINAL_STRAIGHT_SPEED_KFF            (0.0F)
#define DRIVE_ORIGINAL_TURN_LEFT_KP                  (12.24F)
#define DRIVE_ORIGINAL_TURN_LEFT_KI                  (1.77F)
#define DRIVE_ORIGINAL_TURN_LEFT_KD                  (0.68F)
#define DRIVE_ORIGINAL_TURN_RIGHT_KP                 (12.24F)
#define DRIVE_ORIGINAL_TURN_RIGHT_KI                 (1.77F)
#define DRIVE_ORIGINAL_TURN_RIGHT_KD                 (0.68F)
#define DRIVE_ORIGINAL_TURN_SPEED_KFF                (0.0F)
...
/* Allow the PID to use the full 10000-duty PWM range. */
#define DRIVE_520_SPEED_PID_OUTPUT_LIMIT             (10000)
/* Position PID gains in duty/(mm/s), converted from x4 count gains. */
#define DRIVE_520_STRAIGHT_LEFT_KP                   (1.0F)
#define DRIVE_520_STRAIGHT_LEFT_KI                   (0.9F)
#define DRIVE_520_STRAIGHT_LEFT_KD                   (0.3F)
#define DRIVE_520_STRAIGHT_RIGHT_KP                  (1.0F)
#define DRIVE_520_STRAIGHT_RIGHT_KI                  (0.9F)
#define DRIVE_520_STRAIGHT_RIGHT_KD                  (0.3F)
#define DRIVE_520_STRAIGHT_SPEED_KFF                 (4.0F)
#define DRIVE_520_TURN_LEFT_KP                       (0.80F)
#define DRIVE_520_TURN_LEFT_KI                       (0.48F)
#define DRIVE_520_TURN_LEFT_KD                       (0.04F)
#define DRIVE_520_TURN_RIGHT_KP                      (0.80F)
#define DRIVE_520_TURN_RIGHT_KI                      (0.48F)
#define DRIVE_520_TURN_RIGHT_KD                      (0.04F)
#define DRIVE_520_TURN_SPEED_KFF                     (15.0F)
...
#define DRIVE_PROFILE_STRAIGHT_SPEED_KFF             \
    (DRIVE_ORIGINAL_STRAIGHT_SPEED_KFF)
#define DRIVE_PROFILE_TURN_SPEED_KFF                 \
    (DRIVE_ORIGINAL_TURN_SPEED_KFF)
...
#define DRIVE_PROFILE_STRAIGHT_SPEED_KFF             \
    (DRIVE_520_STRAIGHT_SPEED_KFF)
#define DRIVE_PROFILE_TURN_SPEED_KFF                 \
    (DRIVE_520_TURN_SPEED_KFF)
