...
#define GIMBAL_CONFIG_PULSE_ENGINE_HZ           (5000U)
#define GIMBAL_CONFIG_PULSE_TICK_US             (200U)
...
#define GIMBAL_CONFIG_YAW_JOG_SPEED_DEG_S       (30U)
#define GIMBAL_CONFIG_PITCH_JOG_SPEED_DEG_S     (30U)
#define GIMBAL_CONFIG_CALIBRATE_SPEED_DEG_S     (5U)
#define GIMBAL_CONFIG_POSITION_SPEED_DEG_S      (30U)
#define GIMBAL_CONFIG_ACCELERATION_DEG_S2       (180U)
...
#define GIMBAL_CONFIG_LASER_POLARITY_VALID      (0U)
#define GIMBAL_CONFIG_LASER_ACTIVE_LEVEL        (1U)
...
#define GIMBAL_CONFIG_TARGET_CENTER_X_MM        (500.0F)
#define GIMBAL_CONFIG_TARGET_CENTER_Y_MM        (-500.0F)
#define GIMBAL_CONFIG_TARGET_CENTER_Z_MM        (500.0F)
...
#define GIMBAL_CONFIG_PAN_ORIGIN_X_MM           (0.0F)
#define GIMBAL_CONFIG_PAN_ORIGIN_Y_MM           (0.0F)
#define GIMBAL_CONFIG_PAN_ORIGIN_Z_MM           (100.0F)
...
#define GIMBAL_CONFIG_LASER_ORIGIN_X_MM         (0.0F)
#define GIMBAL_CONFIG_LASER_ORIGIN_Y_MM         (0.0F)
#define GIMBAL_CONFIG_LASER_ORIGIN_Z_MM         (0.0F)
