...
#define GIMBAL_CONFIG_STEPS_PER_REVOLUTION       (6400U)
#define GIMBAL_CONFIG_PULSE_ENGINE_HZ           (10000U)
#define GIMBAL_CONFIG_PULSE_TICK_US             (100U)
#define GIMBAL_CONFIG_HARDWARE_PWM_MAX_STEP_HZ  (100000U)
#define GIMBAL_CONFIG_CONTROL_PERIOD_MS         (10U)

#define GIMBAL_CONFIG_YAW_MIN_STEPS             (0)
#define GIMBAL_CONFIG_YAW_MAX_STEPS             (6755)
#define GIMBAL_CONFIG_PITCH_LOW_ANGLE_STEPS     (-533)
#define GIMBAL_CONFIG_PITCH_HIGH_ANGLE_STEPS    (533)
...
#define GIMBAL_CONFIG_POSITION_SPEED_DEG_S      (281U)
#define GIMBAL_CONFIG_ACCELERATION_DEG_S2       (100000U)
