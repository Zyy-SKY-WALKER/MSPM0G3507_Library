...
//   本例程会先通过调试串口发送链接信息，然后会往逐飞助手软件发送波形数据
//
// 9.有可能会在逐飞助手软件上看到波形更新不够连续，这是因为使用WIFI有不确定的延迟导致的
//
//
...
#define WIFI_PASSWORD_TEST      "12365478"                      // 如果需要连接的WIFI 没有密码则需要将 这里 替换为 NULL
