...
#else
//====================================================硬件 IIC 驱动====================================================
#define IMU660RA_IIC_INDEX          ( IIC_1 )                                   // 硬件 IIC 模块号
#define IMU660RA_IIC_SPEED          ( 400 * 1000 )                              // 硬件 IIC 通信时钟速率
#define IMU660RA_SCL_PIN            ( IIC1_SCL_C6 )                             // 硬件 IIC SCL 引脚 连接 IMU660RA 的 SCL 引脚
#define IMU660RA_SDA_PIN            ( IIC1_SDA_C7 )                             // 硬件 IIC SDA 引脚 连接 IMU660RA 的 SDA 引脚
//====================================================硬件 IIC 驱动====================================================
#endif
#else
//====================================================硬件 SPI 驱动====================================================
...
typedef enum
{
    IMU660RA_ACC_SAMPLE_SGN_2G ,                                                // 加速度计量程 ±2 g (ACC = Accelerometer 加速度计) (SGN = signum 带符号数 表示正负范围) (g 代表重力加速度 物理学名词 一般情况下 g 取 9.8 m/s^2 为标准值)
    IMU660RA_ACC_SAMPLE_SGN_4G ,                                                // 加速度计量程 ±4 g (ACC = Accelerometer 加速度计) (SGN = signum 带符号数 表示正负范围) (g 代表重力加速度 物理学名词 一般情况下 g 取 9.8 m/s^2 为标准值)
    IMU660RA_ACC_SAMPLE_SGN_8G ,                                                // 加速度计量程 ±8 g (ACC = Accelerometer 加速度计) (SGN = signum 带符号数 表示正负范围) (g 代表重力加速度 物理学名词 一般情况下 g 取 9.8 m/s^2 为标准值)
    IMU660RA_ACC_SAMPLE_SGN_16G,                                                // 加速度计量程 ±16g (ACC = Accelerometer 加速度计) (SGN = signum 带符号数 表示正负范围) (g 代表重力加速度 物理学名词 一般情况下 g 取 9.8 m/s^2 为标准值)
