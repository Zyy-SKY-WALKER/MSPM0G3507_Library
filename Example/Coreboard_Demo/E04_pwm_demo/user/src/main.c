...
#define PWM_CH1                 (PWM_TIM_G0_CH1_B11)
#define PWM_CH2                 (PWM_TIM_G8_CH1_A27)
#define PWM_CH3                 (PWM_TIM_A0_CH1_B9)
#define PWM_CH4                 (PWM_TIM_A0_CH3_B13)
...
int main (void)
{
    ...
    pwm_init(PWM_CH4, 50, 0);                                               	// 初始化 PWM 通道 频率 50Hz 初始占空比 0%
    // 此处编写用户代码 例如外设初始化代码等
    while(true)
    {
        // 此处编写需要循环执行的代码
